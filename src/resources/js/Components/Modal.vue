<template>
    ...
    <div v-show="showModal" tabindex="-1" aria-hidden="true" class=" fixed inset-0 flex items-center justify-center z-50">
        <div :class="{ 'bg-gray-900 bg-opacity-50': showModal }" tabindex="-1" aria-hidden="true"
            class="fixed inset-0 flex items-center justify-center z-50" @click="handleBackgroundClick">
            <div class="bg-white w-full md:max-w-2xl mx-auto rounded-lg shadow-lg overflow-y-auto">
                <!-- Modal content -->
                <div class="p-4 md:p-5 space-y-4" @click.stop>
                    <!-- Modal header -->
                            ...
                            <div class="mb-4">
                                <div class="flex">
                                    ...
                                    <button type="button" @click="reloadCaptcha"
                                        class="btn bg-red-600 btn-danger red-gradient-button lg:px-3 rounded-3xl lg:ml-3 md:px-4 md:ml-10 sm:px-2 sm:ml-6"
                                        id="reload">
                                        &#x21bb;
                                    </button>
                                </div>
